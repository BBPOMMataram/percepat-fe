...
import AdminPenerimaanFormAtkPercepat from "./AdminPenerimaanFormPerlengkapanPercepat";

export default function AdminPenerimaanPerlengkapanPercepat() {
    ...
    const loadData = useCallback(() => {
        ...
        api.get(`${process.env.NEXT_PUBLIC_BACKEND_URL_PERCEPAT}/api/v1/penerimaan-perlengkapan?${params}`)
            .then(({ data }) => {
                setData(data)
    ...
    const handleRemove = (id: number) => {
        if (window.confirm('Confirm delete?')) {
            api.delete(`${process.env.NEXT_PUBLIC_BACKEND_URL_PERCEPAT}/api/v1/penerimaan-perlengkapan/${id}`)
                .then((res) => {
    ...
    return (
        <>
            ...
            <div className="bg-white rounded-2xl shadow px-8 py-4 mb-2 flex flex-col md:flex-row">
                <div className="text-lg font-semibold text-gray-800 uppercase">Penerimaan Perlengkapan Kebersihan</div>
                    ...
                    <div className="ml-auto flex items-center gap-2">
                        ...
                        <button
                            onClick={() => {
                                ...
                                window.open(`${process.env.NEXT_PUBLIC_BACKEND_URL_PERCEPAT}/api/v1/penerimaan-perlengkapan/export-pdf?${params}`, '_blank');
                            }}
