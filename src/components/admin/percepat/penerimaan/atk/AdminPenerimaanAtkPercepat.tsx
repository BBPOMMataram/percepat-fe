...
export default function AdminPenerimaanAtkPercepat() {
    ...
    const loadData = useCallback(() => {
        ...
        api.get(`${process.env.NEXT_PUBLIC_BACKEND_URL_PERCEPAT}/api/v1/penerimaan-atk?${params}`)
            .then(({ data }) => {
                setData(data)
                    ...
                    <div className="ml-auto flex items-center gap-2">
                        ...
                        <button
                            onClick={() => {
                                ...
                                window.open(`${process.env.NEXT_PUBLIC_BACKEND_URL_PERCEPAT}/api/v1/penerimaan-atk/export-pdf?${params}`, '_blank');
                            }}
