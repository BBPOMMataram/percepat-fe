...
export default function AdminKartuStokReagenPercepat() {
    ...
    const loadData = useCallback(() => {
        ...
        api.get(`${process.env.NEXT_PUBLIC_BACKEND_URL_PERCEPAT}/api/v1/reagen?${params}`)
            .then(({ data }) => {
                setData(data);
    ...
    const downloadHandler = (id: number) => {
        api({
            ...
            .then(({ data }) => {
                ...
                link.href = url;
                link.setAttribute('download', `Kartu-Stok-Reagen-${id}.pdf`);
    ...
    return (
        <>
            <div className="bg-white rounded-2xl shadow px-8 py-4 mb-2 flex flex-col md:flex-row">
                <div className="text-lg font-semibold text-gray-800 uppercase">Kartu Stok Reagen</div>
                    ...
                    <div className="ml-auto flex items-center gap-2">
                        ...
                        <button
                            onClick={() => {
                                ...
                                window.open(`${process.env.NEXT_PUBLIC_BACKEND_URL_PERCEPAT}/api/v1/reagen/export-pdf?${params}`, '_blank');
                            }}
