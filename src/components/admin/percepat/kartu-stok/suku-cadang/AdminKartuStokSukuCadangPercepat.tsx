...
export default function AdminKartuStokSukuCadangPercepat() {
    ...
    const loadData = useCallback(() => {
        ...
        api.get(`${process.env.NEXT_PUBLIC_BACKEND_URL_PERCEPAT}/api/v1/suku-cadang?${params}`)
            .then(({ data }) => {
                setData(data);
    ...
    const downloadHandler = (id: number) => {
        api({
            url: `/api/v1/kartu-stok/suku-cadang/${id}`,
            method: 'GET',
            responseType: 'blob'
        })
            .then(({ data }) => {
                ...
                link.href = url;
                link.setAttribute('download', `Kartu-Stok-Suku-Cadang-${id}.pdf`);
    ...
    return (
        <>
            <div className="bg-white rounded-2xl shadow px-8 py-4 mb-2 flex flex-col md:flex-row">
                <div className="text-lg font-semibold text-gray-800 uppercase">Kartu Stok Suku Cadang</div>
                    ...
                    <div className="ml-auto flex items-center gap-2">
                        ...
                        <button
                            onClick={() => {
                                ...
                                window.open(`${process.env.NEXT_PUBLIC_BACKEND_URL_PERCEPAT}/api/v1/suku-cadang/export-pdf?${params}`, '_blank');
                            }}
