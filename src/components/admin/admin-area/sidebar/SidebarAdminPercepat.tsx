...
export default function SidebarAdminPercepat() {
    ...
    return (
        <aside className="w-16 lg:w-52 bg-white flex flex-col items-center py-3 gap-4 shadow-xl px-2">
            ...
            <div className="dropdown dropdown-right dropdown-center lg:w-full">
                <button className={`flex gap-2 lg:w-full tooltip tooltip-right p-2 rounded-lg ${isActive('/admin/percepat/kartu-stok')}`}
                    data-tip="Kartu Stok">
                    <span className="material-symbols-outlined">
                        warehouse
                    </span>
                    <span className="hidden lg:block whitespace-nowrap">Kartu Stok</span>
                </button>
                <ul
                    tabIndex={0}
                    className="menu dropdown-content bg-base-100 rounded-box z-1 ml-4 max-w-fit p-2 shadow"
                >
                    <li>
                        <Link href={'/admin/percepat/kartu-stok/reagen'}>Reagen</Link>
                    </li>
                    <li>
                        <Link href={'/admin/percepat/kartu-stok/atk'}>ATK</Link>
                    </li>
                    <li>
