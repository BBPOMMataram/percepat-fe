        ...
        <>
            ...
            <div className="hero relative h-screen"> {/* relative here to avoid warning Image has "fill" adn parent elwith invalid "position" */}
                ...
                <div className="backdrop flex h-full w-full absolute bg-gray-800/60">
                    <div className="welcome flex-1 flex flex-col justify-center pl-6">
                        <motion.h1
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            // transition={{ duration: 1 }}
                            className="text-gray-50 text-xl sm:text-2xl md:text-3xl lg:text-5xl mb-4">
                            Selamat datang di
                            <motion.strong
                                initial={{ x: -800 }}
                                animate={{ x: 0 }}
                                transition={{ delay: 0.5 }}
                                className="block text-teriary mt-2">
                                APLIKASI PERCEPAT
                            </motion.strong>
                        </motion.h1>
                        <motion.div
