...
export default function FormSukuCadang({ listBarang, setListBarang }: FormSukuCadangProps) {
    ...
    const fetchSukuCadang = async (query: string) => {
        setIsLoading(true);
        try {
            const res = await api.get(`${process.env.NEXT_PUBLIC_BACKEND_URL_PERCEPAT}/api/v1/barang-suku-cadang-all?name=${query}`);
            ...
            <div className="bg-white p-4 rounded-lg shadow border">
                ...
                <div className="mb-4">
                    <input
                        ...
                        placeholder="Cari suku cadang berdasarkan nama..."
                        value={searchTerm}
